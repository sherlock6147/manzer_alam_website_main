...
from manzer_alam_main_website.users.forms import UserAdminChangeForm
...
from manzer_alam_main_website.users.views import UserRedirectView, UserUpdateView, user_detail_view
